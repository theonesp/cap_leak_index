...
WHERE fluid_balance IS NOT null')
...
```{r}
png("snuh_hist.png", width = 2000, height = 2000, res = 400)
hist(selected_df_mortality$leaking_index, main = "SNUH",  xlab = "VLI", ylab = "Frequency", xlim = c(-15, 5), breaks = 15)
dev.off()
```
