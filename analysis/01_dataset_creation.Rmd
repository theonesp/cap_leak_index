...
```{r}
table1(~ age_fixed + hosp_mort + gender + final_charlson_score + apache_iv  + delta_sofa + totalFluid + predictedHospitalMortality | highest_q_leaking_index, data=selected_df)
```
