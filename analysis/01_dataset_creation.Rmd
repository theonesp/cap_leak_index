...
# actualhospitalmortality mapping (some models are not properly handling facros so they need to be mapped to numbers)
...
# Filters no fluid data patients
# cap_leak_index_dataset<-cap_leak_index_dataset%>%
#   filter(!is.na(totalFluid))
cap_leak_index_dataset<-cap_leak_index_dataset%>%
