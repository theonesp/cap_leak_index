...
## Patients with sepsis and demographics
...
SELECT cap_leak_index_dataset.* FROM
...
cap_leak_index_dataset<-cap_leak_index_dataset%>%
  mutate(
    ...
    leaking_index=((mean_hct_24_36hrs-first_hct_6hrs) / total_intake)
...
cap_leak_index_dataset$delta_sofa_bin<-as.factor(cap_leak_index_dataset$delta_sofa_bin)

# cap_leak_index_dataset$delta_sofa_bin[cap_leak_index_dataset$delta_sofa_bin==1]<-0
# cap_leak_index_dataset$delta_sofa_bin[cap_leak_index_dataset$delta_sofa_bin==2]<-1

# actualhospitalmortality mapping
