...
ggplot(treatment_pscore, aes(x=pscore, fill = highest_q_leaking_index)) + 
  geom_histogram(alpha = 0.3,position="identity")+scale_fill_manual(name="Treatment: Prob of Highest Q of VLI",values=c("#1abc9c","#f1c40f","#2980b9","#e74c3c"),labels=c("Q1","Q2","Q3","Q4"))+theme_minimal()
```
