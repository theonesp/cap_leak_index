...
# INNER JOIN sofa_cv_open ON pt.patientunitstayid = sofa_cv_open .patientunitstayid
...
listVarstab1<-c("age_fixed", "gender", "weight", "height", "unitType", "body_surface_area", "apachescore", "actualicumortality", "actualhospitalmortality", "first_hct_6hrs", "mean_hct_24_36hrs", "AKIstage")

catVars<-c("gender", "actualicumortality", "actualhospitalmortality")

mortality <- CreateTableOne(vars = listVarstab1, data = Final_dataset, factorVars = catVars,testNormal=oneway.test, strata="actualhospitalmortality")
