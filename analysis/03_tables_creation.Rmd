...
write.xlsx(as.data.frame(print(table1)), "table1.csv", col.names=TRUE, row.names=TRUE)
write.xlsx(as.data.frame(print(table1strat)), "table1strat.csv", col.names=TRUE, row.names=TRUE)
