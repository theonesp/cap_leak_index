...
listVarstab1<-c("patientunitstayid", "age_fixed", "gender", "weight", "height", "BMI", "BMI_group", "unitType", "body_surface_area", "apachescore", "unabridgedunitlos", "unabridgedhosplos", "unabridgedactualventdays", "first_hct_6hrs", "mean_hct_24_36hrs", "AKIstage", "delta_sofa", "delta_sofa_bin", "hosp_mortality", "HospitalLOS", "totalFluid")

catVars<-c("gender", "actualicumortality", "hosp_mortality", "delta_sofa_bin")
...
catVars<-c("hosp_mortality")

table1 <- CreateTableOne(vars = listVarstab1, data = table_df, factorVars = catVars,testNormal=oneway.test)

table1strat <- CreateTableOne(vars = listVarstab1, data = selected_df, factorVars = catVars,testNormal=oneway.test, strata="hosp_mortality")
