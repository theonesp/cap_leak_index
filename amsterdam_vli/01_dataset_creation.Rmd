...
patient_included_vector <- sepsis[sepsis$admissionid %!in% patient_inexcluded_icd9$patientunitstayid  ,]
...
vol_leak_index_dataset$q_leaking_index$hosp_mortality = vol_leak_index_dataset$q_leaking_index$actualhospitalmortality
