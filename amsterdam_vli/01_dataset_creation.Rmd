...
table1(~ gender + age_fixed + hosp_mortality + totalFluid + mean_hct_24_36hrs + first_hct_6hrs + charlson_score| q_leaking_index, data=selected_df_fluid)
```
## Summary of dataset
```{r}
...
```{r}
write.csv(selected_df_fluid,'selected_df_fluid_1015.csv')
```
