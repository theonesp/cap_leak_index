...
label(selected_df_fluid$BMI)<-'BMI'
label(selected_df_fluid$unitType)<-'ICU Type'
label(selected_df_fluid$body_surface_area)<-'BSA'
...
label(selected_df_fluid$unabridgedactualventdays)<-'Ventilation Days'
...
label(selected_df_fluid$delta_sofa)<-'Δ Sofa'
label(selected_df_fluid$hosp_mortality)<-'Hospital Mortality'
label(selected_df_fluid$intakes_total)<-'Total Intake 24 hrs.'
label(selected_df_fluid$intakes_total_72)<-'Total Intake 72 hrs.'
