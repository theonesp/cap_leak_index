...
## Old Table 1
```{r}
mimicTable1 <- table1(~ age_fixed + hosp_mortality + gender + final_elixhauser_score + oasis  + delta_sofa + fluid_balance + fluid_balance_72 + mean_hct_24_36hrs + first_hct_6hrs | q_leaking_index, data=selected_df_fluid)
mimicTable1
```
