...
#intake 
intake <- run_query(getSQL("sql/deprecated/intake_old.sql"))
intake72hrs <- run_query(getSQL("sql/deprecated/intake_72hrs_old.sql"))
...
```{r}
vars_in_table1<-c('age_fixed', 'gender'  , 'final_elixhauser_score' , 'oasis'  , 'delta_sofa' ,'sofatotal_day1_cat', 'fluid_balance' ,'fluid_balance_72', 'mean_hct_24_36hrs' , 'first_hct_6hrs','hosp_mortality','leaking_index','los_hospital','los_icu','icu_mortality','mech_vent')
...
```{r}
write.csv(selected_df_fluid,'selected_df_fluid_2558.csv')
```
