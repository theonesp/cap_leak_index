...
```{r}
vars_in_table1<-c('age_fixed', 'gender'  , 'final_elixhauser_score' , 'oasis'  , 'delta_sofa' ,'sofatotal_day1_cat', 'fluid_balance' , 'mean_hct_24_36hrs' , 'first_hct_6hrs','hosp_mortality','leaking_index','los_hospital','los_icu','icu_mortality')
