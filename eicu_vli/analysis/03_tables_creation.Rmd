...
```{r}
vars_in_table1<-c("age_fixed", "gender", "unitType","weight", "height", "body_surface_area", "leaking_index", "final_charlson_score", "apache_iv", "unabridgedunitlos", "unabridgedhosplos", "first_hct_6hrs", "mean_hct_24_36hrs", "hosp_mortality", "fluid_balance","fluid_balance_72")
...
```
```{r}
vars_in_table1<-c("age_fixed", "gender", "unitType", "height", "weight", "body_surface_area", "leaking_index", "final_charlson_score", "apache_iv", "unabridgedunitlos", "unabridgedhosplos", "first_hct_6hrs", "mean_hct_24_36hrs", "hosp_mortality", "fluid_balance")
