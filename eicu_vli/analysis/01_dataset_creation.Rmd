...
```{r}
plot (vol_leak_index_dataset$intakes_total, vol_leak_index_dataset$hosp_mortality, xlim = c(0, 25000))
linearMod <- lm(hosp_mortality ~ intakes_total, data=vol_leak_index_dataset)
summary(linearMod)
```
