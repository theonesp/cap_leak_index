...
```{r}
vars_in_table1<-c('age_fixed', 'gender'  , 'final_charlson_score' , 'apache_iv'  , 'delta_sofa' ,'sofatotal_day1_cat', 'fluid_balance' , 'mean_hct_24_36hrs' , 'first_hct_6hrs', 'actualicumortality', 'hosp_mortality', 'unabridgedunitlos' , 'unabridgedhosplos','leaking_index')
